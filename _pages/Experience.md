...
<figure>
  ...
  <figcaption>Fit to nonresonant background using a lowest-order unbiased function to describe the three-body invariant mass $$m_{\mu\mu\gamma}$$ distribution observed in data for the $$H\to J/\psi+\gamma$$ channel.</figcaption>
</figure>
